...
class ContrastVirtualShareholderPurchase(unittest.TestCase):
    ...
    def test_virtual_shareholder_purchase(self):
        ...
        # 查询sql
        stklisthis_sql = "select * from STKLIST{} where EXCHID = '0' and REGID = 'A117292001' and STKID = '603999' " \
                      "and DESKID = '00W40' and OCCURTIME = {}".format(year,begintime)
        stklist_sql = " select * from STKLIST where EXCHID = '0' and REGID = 'A117292001' and STKID = '603999'  "
        account_sql = "select * from ACCOUNT where ACCTID = '000011729201' and CURRENCYID='00'  "
        tradinglog_sql = "select * from tradinglog{} where reckoningtime>={} and reckoningtime<={} and exchid= '0' " \
                         "and  STKID = '603999' and briefid ='005_001_001' and REGID = 'A117292001'".format(year,begintime,endtime)
        # 数据库数据
        ...
        # 断言
        final_result = stklisthis_result + account_result + tradinglog_result + stklist_result
        if not final_result:
