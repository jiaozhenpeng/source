...
class ContrastStockPurchase(unittest.TestCase):
    ...
    def test_stock_purchase(self):
        ...
        # 查询sql
        account_sql= "select * from ACCOUNT where ACCTID = '000011729200' and CURRENCYID ='00'  "
        stklisthis_sql = "select * from STKLIST{} where EXCHID = '0' and REGID ='A117292000' and " \
                      "STKID ='603998' and DESKID = '00W40' and occurtime={}".format(year,begintime)
        stklist_sql = "select * from STKLIST where EXCHID = '0' and REGID ='A117292000' and stkid='603998' "
        tradinglog_sql = "select * from tradinglog{} where reckoningtime>={} and reckoningtime<={} and exchid= '0'" \
                         " and STKID ='603998' and briefid = '005_001_001' and REGID ='A117292000'".format(year,begintime,endtime)
        # 数据库数据
        ...
        stklisthis_result = base.compare_dict(stklisthis_database, stklisthis_excel, 'stklisthis', *stklisthis_ignore)
        stklist_result = base.compare_dict(stklist_database,stklist_excel,'stklist')
        tradinglog_result = base.compare_dict(tradinglog_database, tradinglog_excel, 'tradinglog', *tradinglog_ignore)
        # 断言
        final_result = account_result + stklisthis_result + tradinglog_result + stklist_result
        if not final_result:
