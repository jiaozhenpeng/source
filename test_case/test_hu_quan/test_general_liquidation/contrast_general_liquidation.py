...
class ContrastGeneralLiquidation(unittest.TestCase):
    ...
    def test_general_liquid(self):
        ...
        futureposition_sql = "select * from futureposition WHERE regid='A117212005'   and stkid" \
                             " in('10002692','10002767','10002690','10002726') "
        ...
        futurepositionhis_excel = base.futureposition_sort(excel.read_excel('futureposition2021'))
        futurepositiondetailhis_excel = base.futurepositiondetail_sort(excel.read_excel('futurepositiondetail2021'))
