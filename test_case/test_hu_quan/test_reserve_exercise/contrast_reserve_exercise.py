...
class ContrastReserveExercise(unittest.TestCase):
    ...
    def test_reserve_exercise(self):
        ...
        futuretradinglog_sql = "select * from futuretradinglog{}  where reckoningtime>={} and reckoningtime<={} and " \
                               "exchid='X' and regid='A117212005' and stkid in('10003527')".format(year, begintime,
                                                                                                   endtime)
        futurepositionhis_sql = "select * from futureposition{} WHERE regid='A117212005'  and occurtime={} and stkid " \
                                "in(10003527)".format(year, begintime)
        futurepositiondetailhis_sql = "select * from futurepositiondetail{} WHERE regid='A117212005'  and occurtime={} " \
                                      "and stkid in(10003527)".format(year, begintime)
        futureposition_sql = "select * from futureposition WHERE regid='A117212005'   and stkid  in(10003527) "
