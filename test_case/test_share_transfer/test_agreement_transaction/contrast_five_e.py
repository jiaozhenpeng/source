...
class ContrastFiveE(unittest.TestCase):
    ...
    def test_five_e(self):
        ...
        # 断言
        final_result = account_result + stklist_result + tradinglog_result + todaytraderslt_result + \
                       finalreckoningresult_result + stkauditingerror_result + openorder_result
        if not final_result:
